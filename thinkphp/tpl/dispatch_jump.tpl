...
<div id="js-alert-box" class="alert-box">
    ...
    <div class="alert-body">
        ...
        <?php switch ($code) {?>
            <?php case 1:?>
            <h1><p class="success" style="color:green"><?php echo(strip_tags($msg));?></p></h1>
            <?php break;?>
            <?php case 0:?>
            <h1><p class="error" style="color:red"><?php echo(strip_tags($msg));?></p></h1>
            <?php break;?>
        <?php } ?>
        </div>
        <a id="js-alert-btn" class="alert-btn" href="<?php echo($url);?>">跳转</a>
    </div>
    <div class="alert-footer clearfix">
        ...
        <div class="alert-footer-text"><p>secure</p>惜光阴如梭 </div>
    </div>
</div>
...
function alertSet(e) {
    ...
    setInterval(function() {
        if (0 == t){
            var href = document.getElementById('js-alert-btn').href;
            console.log(href);
            location.href = href;
        }else {
            t -= 1,
